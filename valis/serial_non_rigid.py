    ...
    def __init__(
        ...
        if isinstance(src, serial_rigid.SerialRigidRegistrar):
            ...
            valtils.print_warning(
                "src must be either a SerialRigidRegistrar, string, or dictionary"
            )
            return None
        ...
        if self.align_to_reference is False and reference_img_f is not None:
            ...
            msg = (
                ...
                "but `align_to_reference` is `False`, and so images will be aligned serially. ",
