    ...
    def match_sorted_imgs(self, matcher_obj, keep_unfiltered=False, qt_emitter=None):
        ...
        def match_adj_img_obj(i):
            ...
            if len(filtered_match_info12.matched_kp1_xy) == 0:
                warnings.warn(
                    f"{len(filtered_match_info12.matched_kp1_xy)} matches between {img_obj_1.name} and {img_obj_2.name}"
                )
    ...
    def align_to_prev_check_reflections(
        ...
        for moving_idx, fixed_idx in tqdm(
            ...
            prev_warped = warp_tools.warp_img(
                prev_img_obj.image, prev_M, out_shape_rc=prev_img_obj.padded_shape_rc
            )
